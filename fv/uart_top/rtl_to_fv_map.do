...
# Generated on: Mon Apr 13 19:04:01 IST 2026 (Mon Apr 13 13:34:01 UTC 2026)
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  uart_rx.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  uart_tx.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  uart_top.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/uart_top/rtl_to_fv_map.log
}
